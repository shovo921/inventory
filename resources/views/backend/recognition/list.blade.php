                                                ...
                                                @foreach($data2 as $data2)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            @endif
                                                            <a type="button" class="btn btn-danger btn-sm delete"  role="button" title="please, click to delete Contact"  data-bs-toggle="modal1" data-bs-target="#basicModal1" onclick="myFunction({{$data2->id}})" ><i class="bi bi-x-circle"></i></a></td>
                                                    </tr>
