...
{{--                                    <td style="width:100%;" class="text-center"><img class="img-responsive" src="{{asset('frontend/server/image/story')}}/{{$data1->image}}"/>--}}
                                    ...
                                    <td><a class="btn btn-success btn-sm" href="{{ route('story.edit', ['id' => $data1->id]) }}" role="button" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Tooltip on top"><i class="bi bi-eye"></i></a>
