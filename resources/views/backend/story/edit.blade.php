        ...
        <section class="section">
            <div class="row">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Edit Story </h5>
                            @if ($errors->any())
                            ...
                            @endif
                            <form class="row g-3" action="{{route('story.update')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="col-md-6 ">
                                    ...
                                    <div class="preview-container">
                                        <img id="preview" class="preview-hidden"
                                             src="{{asset('frontend/server/image/story')}}/{{$data->image}}">
                                        <div class="icon">
                                            <i class="ri-close-circle-fill delete-icon"></i>
                                        </div>
                                    </div>
                                    <input type="file" id="input"  name="image">
                                    <label for="input" class="custom-file-input">please Story Image</label>
                                </div>
