                ...
                <div class="row justify-content-center">
                    <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                        <div class="d-flex justify-content-center py-4"><a href="index.html"
                                ...
                                <img src="assets/img/logo.png" alt=""> <span class="d-none d-lg-block">Admin</span> </a>
                        </div>
                        <div class="card mb-3">
                            <div class="card-body">
                                <div class="pt-4 pb-2">
                              ...
                              <p x-auth-session-status class="mb-4" :status="session('status')"> </p>
                                ...
                                <!-- Validation Errors -->
                               <p><x-auth-validation-errors class="mb-4" :errors="$errors" /></p>
                                <form method="POST" action="{{ route('admin.login.store') }}">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="input-group has-validation">
                                            <span class="input-group-text" id="inputGroupPrepend">@</span> <input
                                                type="text"  class="form-control" id="yourUsername"  name="email" :value="old('email')"
                                                required>
                                    ...
                                    <div class="col-12">
                                        <label for="yourPassword" class="form-label">Password</label> <input
                                            ...
                                            required autocomplete="current-password" class="form-control" id="yourPassword"
                                            required>
                                    ...
                                    <div class="col-12">
                                        <p class="small mb-0">Don't have account? Talk with admin </p>
                                    </div>
                                </form>
                            </div>
                        </div>
