...
{{--                <li> <a href="components-tooltips.html"> <i class="bi bi-circle"></i><span>Tooltips</span> </a></li>--}}
        ...
        <li class="nav-item">
            <a class="nav-link collapsed " data-bs-target="#components-nav-c" data-bs-toggle="collapse"  href="#"> <i class="bi bi-menu-button-wide"></i><span>Pakage</span><i class="bi bi-chevron-down ms-auto"></i> </a>
            <ul id="components-nav-c" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                <li> <a href="{{route('conatct.list')}}"> <i class="bi bi-circle"></i><span>Pakage list</span> </a></li>
                <li> <a href="{{route('conatct.list')}}"> <i class="bi bi-circle"></i><span>Pakage create</span> </a></li>
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#charts-nav" data-bs-toggle="collapse" href="#"> <i class="bi bi-bar-chart"></i><span>Service</span><i class="bi bi-chevron-down ms-auto"></i> </a>
            <ul id="charts-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                <li> <a href="{{route('service.list')}}"> <i class="bi bi-circle"></i><span>Service list</span> </a></li>
                <li> <a href="{{route('service.create')}}"> <i class="bi bi-circle"></i><span>Create new Service</span> </a></li>
            </ul>
        </li>
        <li class="nav-item">
