                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="row g-3" action="{{route('product.store')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="number" class="form-control" id="quantity" placeholder="quantity" value="{{ old('quantity') }}"
                                               name="quantity">
                                ...
                                <div class="col-md-6 ">
                                    ...
                                    <label for="input" class="custom-file-input">please upload Product Image </label>
                                </div>
